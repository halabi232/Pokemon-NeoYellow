...
{
    // Level 50
    {FRONTIER_MON_GRIMER,       FRONTIER_MON_RATICATE_1},   // 43 - 77
    {FRONTIER_MON_LICKITUNG_1,  FRONTIER_MON_CLOYSTER_1},   // 64 - 100
    {FRONTIER_MON_LICKITUNG_2,  FRONTIER_MON_CLOYSTER_2},   // 101 - 137
    ...
    {FRONTIER_MON_DUGTRIO_3, FRONTIER_MON_ARCANINE_3}, // 224 - 267
    {FRONTIER_MON_DUGTRIO_4, FRONTIER_MON_ARCANINE_4}, // 268 - 311
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS - 1},  // 138 - 362
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS - 1},  // 138 - 362
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS - 1},  // 138 - 362
    {FRONTIER_MON_DUGTRIO_1, NUM_FRONTIER_MONS - 1},  // 138 - 362
};
