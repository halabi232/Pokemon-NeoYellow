...
static const s8 sFriendshipEventModifiers[][3] =
{
    ...
    [FRIENDSHIP_EVENT_LEAGUE_BATTLE]   = { 10,  5,  2},
    [FRIENDSHIP_EVENT_LEARN_TMHM]      = { 1,  1,  0},
    [FRIENDSHIP_EVENT_WALKING]         = { 1,  1,  1},
    [FRIENDSHIP_EVENT_MASSAGE]         = { 30,  30, 30},
    [FRIENDSHIP_EVENT_FAINT_SMALL]     = {-1, -1, -1},
    [FRIENDSHIP_EVENT_FAINT_FIELD_PSN] = {-5, -5, -10},
    [FRIENDSHIP_EVENT_EFFORT_BERRIES]  = { 20, 15, 10},
    ...
    case EVO_MODE_NORMAL:
        ...
        for (i = 0; evolutions[i].method != EVOLUTIONS_END; i++)
        {
            ...
            case EVO_LEVEL_NIGHT:
                UpdateTimeOfDay();
                if (gTimeOfDay == TIME_OF_DAY_NIGHT && gEvolutionTable[species][i].param <= level)
                    ttargetSpecies = evolutions[i].targetSpecies;
                break;
