...
const u16 gMetatiles_ContestPrim[] = INCBIN_U16("data/tilesets/primary/contestprim/metatiles.bin");

const u16 gMetatileAttributes_ContestPrim[] = INCBIN_U16("data/tilesets/primary/contestprim/metatile_attributes.bin");