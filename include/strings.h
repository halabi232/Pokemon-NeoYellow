...
extern const u8 gText_TM80AndPrice[];
extern const u8 gText_TM83AndPrice[];
extern const u8 gText_TM84AndPrice[];
extern const u8 gText_TM97AndPrice[];
extern const u8 gText_TM98AndPrice[];
extern const u8 gText_TM99AndPrice[];
...
extern const u8 gText_ToxicOrb32BP[];
extern const u8 gText_FlameOrb32BP[];
extern const u8 gText_FocusSash16BP[];
extern const u8 gText_ZoomLens32BP[];
extern const u8 gText_GripClaw32BP[];
extern const u8 gText_StickyBarb16BP[];
extern const u8 gText_AirBalloon16BP[];
extern const u8 gText_BindingBand32BP[];
extern const u8 gText_EjectButton32BP[];
extern const u8 gText_WeaknessPolicy48BP[];
extern const u8 gText_AssaultVest48BP[];
extern const u8 gText_SafetyGoggles32BP[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ToxicOrb[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FlameOrb[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_FocusSash[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_ZoomLens[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_GripClaw[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_StickyBarb[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AirBalloon[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BindingBand[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_EjectButton[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_WeaknessPolicy[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_AssaultVest[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SafetyGoggles[];
