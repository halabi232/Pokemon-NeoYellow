...
#define EXCHANGE_CORNER_HOLD_ITEM_CLERK_2  	5
#define EXCHANGE_CORNER_POWER_ITEM_CLERK  	6
#define EXCHANGE_CORNER_MINT_LADY    	 	7
#define EXCHANGE_CORNER_MINT_LADY_2  	 	8
#define EXCHANGE_CORNER_CANDY_CLERK  		9
