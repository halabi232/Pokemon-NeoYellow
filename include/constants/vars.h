...
#define VAR_IS_CHAMPION         	        0x40A3 //For Events triggered after becoming champion
#define VAR_LILYCOVE_CONTEST_LOBBY_STATE    0x40A4
#define VAR_LILYCOVE_MUSEUM_2F_STATE    	0x40A5
