...
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_MINT_LADY     	   	3
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_MINT_LADY_2        	4
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_ABILITY_VENDOR     	5
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR     	6
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_POWER_ITEM_VENDOR  	7
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_CANDY_VENDOR  	   	8
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR   	9
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR_2 	10
#define SCROLL_MULTI_BERRY_POWDER_VENDOR                  	11
#define SCROLL_MULTI_BF_RECEPTIONIST                      	12
#define SCROLL_MULTI_BF_MOVE_TUTOR_1                      	13
#define SCROLL_MULTI_BF_MOVE_TUTOR_2                      	14
#define SCROLL_MULTI_SS_TIDAL_DESTINATION                 	15
#define SCROLL_MULTI_BATTLE_TENT_RULES                    	16
