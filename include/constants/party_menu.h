...
#define PARTY_MENU_TYPE_EGG_MOVE_TUTOR            8
#define PARTY_MENU_TYPE_UNION_ROOM_REGISTER       9  // trading board
#define PARTY_MENU_TYPE_UNION_ROOM_TRADE          10 // trading board
#define PARTY_MENU_TYPE_SPIN_TRADE                11 // Unused beta for Gen IV's Spin Trade
#define PARTY_MENU_TYPE_MINIGAME                  12
#define PARTY_MENU_TYPE_STORE_PYRAMID_HELD_ITEMS  13
