...
struct SaveBlock1
{
    ...
    /*0x2734*/ u8 decorationDesks[2];
    /*0x273E*/ u8 decorationChairs[2];
    /*0x2748*/ u8 decorationPlants[2];
    /*0x2752*/ u8 decorationOrnaments[5];
    /*0x2770*/ u8 decorationMats[10];
    /*0x278E*/ u8 decorationPosters[2];
